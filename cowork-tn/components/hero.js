...
export async function Hero({ locale }) {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-border/40 bg-gradient-to-br from-primary/5 via-background to-accent/5 p-8 md:p-12 dark:border-border/20 dark:from-primary/10 dark:via-background dark:to-accent/10">
      {/* Decorative elements */}
